...
def Pose_Detected(cap, use_vedio, internal_test, choose_count):
    ...
    if(use_vedio):
        cap = cv2.VideoCapture('./data/Test_Media/Sit_ups.mp4')
    ...
    while True:
        ...
        if success:
            ...
            img = Global_Use.sport(img, angle1_1, 85, 125, bar_displacement, str(int(count)), accuracy_text, text_displacement, text, imgc, imgr)
